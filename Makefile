...
DEBUG_DUMMY_1:
	$(SCRIPT_PATH) $(SERVER) $(CLIENT_SMUGGLER) $(CLIENT_SLIPPERY) $(CONFIG_1) $(MAP_1) 5 debug_vs_dummy_map_1
DEBUG_DUMMY_2:
	$(SCRIPT_PATH) $(SERVER) $(CLIENT_SMUGGLER) $(CLIENT_SLIPPERY) $(CONFIG_2) $(MAP_2) 5 debug_vs_dummy_map_2
